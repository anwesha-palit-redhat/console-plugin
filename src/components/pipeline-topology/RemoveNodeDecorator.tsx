...
import { t_temp_dev_tbd as greyColor /* CODEMODS: you should update this color token, original v5 token was global_palette_black_500 */ } from '@patternfly/react-tokens';

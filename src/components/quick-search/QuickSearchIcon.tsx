...
import { t_temp_dev_tbd as globalWhite /* CODEMODS: you should update this color token, original v5 token was global_palette_white */ } from "@patternfly/react-tokens/dist/js/t_temp_dev_tbd";
...
const QuickSearchIcon: React.FC<React.HTMLProps<SVGElement>> = ({
  ...
  return (
    ...
    >
      <style>
        {
          '.prefix__st0{display:none}.prefix__st2,.prefix__st3{fill-rule:evenodd;clip-rule:evenodd}'
        }
      </style>

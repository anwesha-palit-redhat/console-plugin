...
const PipelineRunsStatusCardK8s: React.FC<PipelinesRunsStatusCardProps> = ({
  ...
  let xAxisStyle: ChartAxisProps['style'] = {
    tickLabels: {
      fill: 'var(--pf-t--temp--dev--tbd)' /* CODEMODS: original v5 color was --pf-v6-global--Color--100 */,
    },
  };
                  ...
                  <div className="pipeline-overview__pipelinerun-status-card__donut-chart-div">
                    <ChartDonut
                      ...
                      subTitleComponent={
                        <ChartLabel
                          style={{
                            fill: 'var(--pf-t--temp--dev--tbd)' /* CODEMODS: original v5 color was --pf-v6-global--Color--400 */,
                            fontSize: 14,
                          }}
                        />
                      }
